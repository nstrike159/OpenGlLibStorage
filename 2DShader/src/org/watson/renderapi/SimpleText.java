	...
	public static void drawString(String s, int x, int y) {
		...
		for (char c : s.toLowerCase().toCharArray()) {
			if (c == 'a') {
				...
				for (int i = 0; i <= 8; i++)
					GL11.glVertex2f(x + i / 2 + 1, y + i);
				for (int i = 8; i >= 0; i--)
					GL11.glVertex2f(x + i / 2 + 1, y + 8 - i);
				x += 6;
			} else if (c == 'y') {
				GL11.glVertex2f(x + 4, y);
				...
				GL11.glVertex2f(x + 7, y + 3);
				GL11.glVertex2f(x + 7, y + 2);
				GL11.glVertex2f(x + 8, y + 2);
				GL11.glVertex2f(x + 8, y + 3);
				x += 8;
			} else if (c == '^') {
				GL11.glVertex2f(x + 1, y + 7);
				GL11.glVertex2f(x + 4, y + 7);
				GL11.glVertex2f(x + 2, y + 8);
				GL11.glVertex2f(x + 3, y + 8);
				x += 5;
			} else if (c == '&') {
				GL11.glVertex2f(x + 2, y + 0);
				GL11.glVertex2f(x + 3, y + 0);
